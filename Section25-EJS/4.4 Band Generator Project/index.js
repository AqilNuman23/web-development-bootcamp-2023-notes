...
app.post("/submit", (req, res) => {
  ...
  const randomGenAdj = Math.floor(Math.random() * adjLength);
  const randomGenNoun = Math.floor(Math.random() * nounLength);

  const selectedAdj = adj[randomGenAdj];
  const selectedNoun = noun[randomGenNoun];

  const selectedName = selectedAdj + " " + selectedNoun;
  res.render("index.ejs", { selectedName });
